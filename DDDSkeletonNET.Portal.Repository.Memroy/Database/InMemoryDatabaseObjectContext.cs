...
namespace DDDSkeletonNET.Portal.Repository.Memroy.Database
{
    public class InMemoryDatabaseObjectContext
    {
        ...
        private void InitializeDatabaseCustomers()
        {
            ...
            {
                new DatabaseCustomer() { Address = "Main street", City = "Birmingham", Country = "UK", CustomerName = "GreatCustomer", Id = 1, Telephone = "N/A" },
                new DatabaseCustomer() { Address = "Strandvägen", City = "Stockholm", Country = "Sweden", CustomerName = "BadCustomer", Id = 2, Telephone = "123345456" },
                new DatabaseCustomer() { Address = "Kis utca", City = "Budapest", Country = "Hungary", CustomerName = "FavouriteCustomer", Id = 3, Telephone = "987654312" }
            };
        }
